...
程刚是一位拥有十多年实战经验的基础设施与平台工程师，长期工作于本地数据中心、虚拟化环境、云原生基础设施以及完整的 <span style="color:red;"><strong>Red Hat 技术生态</strong></span>。他具备 <span style="color:red;"><strong>RHEL</strong></span>、<span style="color:red;"><strong>Red Hat Satellite</strong></span>、<span style="color:red;"><strong>OpenShift / OCP</strong></span>、<span style="color:red;"><strong>OpenShift Virtualization</strong></span> <span style="color:red;"><strong>Ansible Automation Platform</strong></span>、Kubernetes、<span style="color:red;"><strong>裸金属基础设施</strong></span>、<span style="color:red;"><strong>Linux 与 Windows 系统管理</strong></span>、<span style="color:red;"><strong>IaC</strong></span>、<span style="color:red;"><strong>CI/CD 流水线</strong></span>、可观测性与安全加固等方面的实践能力，尤其擅长在复杂环境中推进平台建设、运维治理、故障排查与基础设施迁移工作。

他的经历包括支撑运行在 <span style="color:red;"><strong>VMware vSphere / ESX</strong></span> 上的大规模 Red Hat 虚拟机环境、构建和运营 <span style="color:red;"><strong>裸金属</strong></span> Kubernetes 平台、验证并加固 VMware 模板镜像、自动化操作系统升级与补丁管理，以及与基础设施团队、开发团队和业务方协作，推动低风险、可审计的变更落地。他也具备 <span style="color:red;"><strong>虚拟机迁移规划</strong></span>、<span style="color:red;"><strong>容量评估</strong></span>、以及 <span style="color:red;"><strong>操作系统、网络、存储层面的故障排查</strong></span> 理论和实践经验。通过在 Sopra Steria 为包括 <span style="color:red;"><strong>投资银行</strong></span> 在内的客户提供平台相关工作，他也积累了受监管金融环境中的实践，理解在 <span style="color:red;"><strong>合规</strong></span>、<span style="color:red;"><strong>安全</strong></span> 与 <span style="color:red;"><strong>稳定性</strong></span> 要求都很高的场景下，为什么 Red Hat 技术栈更容易满足可控、可审计、可维护的要求。
