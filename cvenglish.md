...
<div id="webaddress">
<a href="https://www.redhat.com/en/blog/announcing-2024-red-hat-certified-professional-year-gang-cheng">Red Hat Bio</a> | <a href="https://www.linkedin.com/in/gang-cheng-7170a521/">Linkedin page</a> | <a href="https://www.credly.com/users/gang-cheng.7632b4b0">Credly</a>
</div>

## Summary

Gang is an infrastructure and platform engineer with more than ten years of hands-on experience across on-prem data centres, virtualization-heavy environments, and the broader <span style="color:red;"><strong>Red Hat ecosystem</strong></span>. He has worked across <span style="color:red;"><strong>RHEL</strong></span>, <span style="color:red;"><strong>Red Hat Satellite</strong></span>, <span style="color:red;"><strong>OpenShift / OCP</strong></span>, <span style="color:red;"><strong>OpenShift Virtualization</strong></span> training, <span style="color:red;"><strong>Ansible Automation Platform</strong></span>, Kubernetes, <span style="color:red;"><strong>bare-metal infrastructure</strong></span>, <span style="color:red;"><strong>Linux and Windows administration</strong></span>, <span style="color:red;"><strong>IaC</strong></span>, <span style="color:red;"><strong>CI/CD pipeline</strong></span> environments, observability, and security hardening, and is particularly effective in roles that combine platform delivery with operational troubleshooting and migration work.

His background includes supporting large Red Hat VM estates on <span style="color:red;"><strong>VMware vSphere / ESX</strong></span>, building and operating <span style="color:red;"><strong>bare-metal</strong></span> Kubernetes platforms, validating hardened VMware images, automating OS lifecycle and patching, and working with both infrastructure and application stakeholders to deliver controlled change in complex environments. He has recent knowledge  and hands-on experience with <span style="color:red;"><strong>VM migration planning</strong></span>, <span style="color:red;"><strong>capacity management</strong></span>, and <span style="color:red;"><strong>OS, network, and storage troubleshooting</strong></span> across mixed Linux and Windows environments. Through client work at Sopra Steria, including an <span style="color:red;"><strong>investment banking</strong></span> environment, he has also contributed to compliance-oriented platform design and audit-ready operational practices in regulated, security-sensitive settings where <span style="color:red;"><strong>compliance</strong></span>, <span style="color:red;"><strong>security</strong></span>, and <span style="color:red;"><strong>stability</strong></span> are critical and the Red Hat stack is valued for consistency, supportability, and control.

Gang continuously builds new technical depth through hands-on projects, Red Hat certifications, training, workshops, and peer collaboration. His dedication and technical breadth were formally recognized when he was named the <span style="color:red;"><strong>Red Hat Certified Professional of the Year 2024</strong></span>, the sole global recipient of the award. He combines strong troubleshooting ability, structured communication, and pragmatic execution to deliver stable platforms and low-risk infrastructure change.
...
The organisation needed to both upgrade a large RHEL7 estate on **VMware vSphere** approaching end-of-support and prepare RHEL9 for future production rollout. These required two parallel streams: automating the migration of existing systems and validating the next-generation OS for compatibility, stability and security.
...
- Managing Virtual Machines with Red Hat OpenShift Virtualization (DO316) - Ver. 4.14 badge
...
Managing Virtual Machines with Red Hat OpenShift Virtualization (DO316) - Ver. 4.14
